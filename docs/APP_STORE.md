...
brand-asset license. The script requires publisher-controlled Team and bundle
identifiers, verifies the resulting archive, and deliberately performs no
upload. See `RELEASE.md` for the exact commands and gates.
